<template>
  <div
    class="col-sm-6 col-md-4 item my-2  px-2"
  ...
  >
    <div class="thumbnail card">
      ...
      <div class="card-body d-flex flex-column">
        ...
        <p>
          <span class="product__price--strike text-muted mr-1">$210</span>
          <span class="lead font-weight-bold">${{ item.price }}</span>
        </p>
        <div class="d-flex mt-auto">
          ...
          <button class="btn btn-outline-warning ml-2" @click="addWishlistItem">
